...
@else
<form action="{{ url('/bidang/' . $bidang->bidang_id.'/update_ajax') }}" method="POST" id="form-edit-bidang">
    @csrf
    @method('PUT')
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $bidang->bidang_nama }}" type="text" name="bidang_nama" id="bidang_nama"
                        class="form-control" required>
