    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <div class="card-tools">
                ...
                <button onclick="modalAction('{{ url('/role/import') }}')" class="btn btn-sm btn-info mt-1">Import
                    Jabatan</button>
                <button onclick="modalAction('{{ url('/role/create_ajax') }}')" class="btn btn-sm btn-success mt-1">Tambah</button>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
