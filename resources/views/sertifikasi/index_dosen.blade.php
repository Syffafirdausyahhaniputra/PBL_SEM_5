    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title mb-1 font-weight-bold">{{ $item->sertif->nama_sertif }}</h5>
                    <p class="card-text text-muted mb-1">Bidang: {{ $item->sertif->bidang->bidang_nama ?? 'Tanpa Bidang' }}</p>
                    <p class="card-text text-muted mb-1">Penyelenggara: {{ $item->sertif->vendor->vendor_nama ?? 'Tidak Diketahui' }}</p>
                </div>
            </div>
            @endforeach
