    ...
    <div id="modal-master" class="modal-dialog modal-lg" jenis="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Import Jenis Sertifikasi</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_jenis.xlsx') }}" class="btn btn-info btn-sm" download><i
                ...
                <div class="form-group">
                    ...
                    <small id="error-file_jenis" class="error-text form-text text-danger"></small>
                </div>
            </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // jika sukses 
                            ...
                            datajenis.ajax.reload(); // reload datatable 
                        } else { // jika error 
                            $('.error-text').text('');
